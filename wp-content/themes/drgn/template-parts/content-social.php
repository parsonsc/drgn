				...
				<div class="container container_small nopadding">
					<div class="entry-content">
						<div class="col-md-8 signup_form">
							<div class="col-sm-12">
								<h3><?php the_field('stay_tuned_title'); ?></h3>
								<p><?php the_field('stay_tuned_message'); ?></p>
							</div>
											...
											<div class="">
												<div>
													<label for="multiple_checkboxes_1528808822659-0" class="i-checks">
														<input type="checkbox" name="multiple_checkboxes_1528808822659-0" id="multiple_checkboxes_1528808822659-0" value="Yes, I would like to receive updates of the latest DRGN drink news, events and product info via the means of communication I have provided." required=""><i></i>
